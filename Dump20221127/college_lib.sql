...
CREATE TABLE `lib` (
  ...
  `status` varchar(255) DEFAULT 'avaiable',
  PRIMARY KEY (`isbn`)
...
INSERT INTO `lib` VALUES ('java','4888','me','bspub','avaiable'),('Let Us C','8183331637',' Yashavant Kanetka','BPB Publications','available');
