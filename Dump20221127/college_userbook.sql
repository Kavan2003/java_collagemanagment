...
CREATE TABLE `userbook` (
  ...
  KEY `id_no` (`id_no`),
  KEY `isbn` (`isbn`),
  CONSTRAINT `userbook_ibfk_1` FOREIGN KEY (`id_no`) REFERENCES `users` (`ID_NO`),
  CONSTRAINT `userbook_ibfk_2` FOREIGN KEY (`isbn`) REFERENCES `lib` (`isbn`)
...
-- Dump completed on 2022-11-27 13:12:15
